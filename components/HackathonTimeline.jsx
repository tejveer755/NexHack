  ...
  const data =[
  {
    ...
    content: (
      <div className="text-xs sm:text-sm md:text-base text-neutral-300">
        ...
        <p className="mt-3">
          Selected teams will move forward to the offline round at IIITM Janakpuri for the main hackathon event.
        </p>
      </div>
    ),
  },
    ...
    <div className="relative w-full overflow-clip px-4 py-12" id="schedule">
      ...
      <div className="mt-10 flex justify-center">
        <div className="relative group w-fit">
          ...
          >
            <span>Refer to the official guidelines for clear and reliable instructions</span>
          </div>
        </div>
      </div>
    </div>
