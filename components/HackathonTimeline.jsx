...
export function HackathonTimeline() {
 ...
 const data = [
  {
    title: "Round 1: Online Screening for Shortlisting",
    ...
    content: (
      <div className="text-xs sm:text-sm md:text-base text-neutral-300">
        ...
        <ul className="list-disc space-y-1.5 pl-4">
          <li><span className="font-semibold">10:00 AM – 3:00 PM:</span> Problem Statement Briefing and Idea Presentation (Google Meet)</li>
          <li><span className="font-semibold">3:00 PM – 4:00 PM:</span> Lunch Break</li>
          <li><span className="font-semibold">4:00 PM – 8:00 PM:</span> Problem Statement Briefing and Idea Presentation (Google Meet) continues</li>
          <li><span className="font-semibold">8:00 PM – 10:00 PM:</span> Submission Window</li>
    ...
    content: (
      <div className="text-xs sm:text-sm md:text-base text-neutral-300">
        ...
        <ul className="list-disc space-y-1.5 pl-4">
          ...
          <li><span className="font-semibold">11:00 AM – 8:00 PM:</span> Hackathon Begins</li>
  ...
  },
  {
    ...
    content: (
      <div className="text-xs sm:text-sm md:text-base text-neutral-300">
        ...
        <ul className="list-disc space-y-1.5 pl-4">
          <li><span className="font-semibold">8:30 AM – 9:30 AM:</span> Breakfast</li>
          <li><span className="font-semibold">9:30 AM – 10:30 AM:</span> Project Wrap-Up Time</li>
          <li>
            <span className="font-semibold">10:30 AM – 1:00 PM:</span>{" "}
            ...
            <p className="mt-1">Top 10 to 12 teams will be shortlisted for the final judging round.</p>
          </li>
          <li><span className="font-semibold">1:00 PM – 2:00 PM:</span> Break</li>
          <li>
          ...
          <li><span className="font-semibold">4:00 PM – 5:00 PM:</span> Closing Ceremony & Prize Distribution</li>
          <li><span className="font-semibold">5:00 PM – 6:00 PM:</span> Networking & Certificates</li>
        </ul>
      </div>
    ),
  }
