...
export default function HeroBackground() {
  return (
    <div className="absolute inset-0 w-full z-[-1] min-h-screen bg-black text-white font-sans overflow-hidden">
      <div className="absolute inset-0  bg-gradient-to-br from-[#f29af8] via-30% via-[#6320e8] to-[#c96639] [mask-image:radial-gradient(900px_circle_at_0%_10%,white,transparent)]"></div>
      <div className="absolute inset-0   bg-gradient-to-br from-[#ab2aec]  via-transparent  to-[#984b18] [mask-image:radial-gradient(670px_circle_at_60%_5%,white,transparent)]"></div>
