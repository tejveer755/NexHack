  ...
  return (
    (<div
      ...
      <ul
        ...
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-b-0 border-zinc-200 bg-[linear-gradient(180deg,#fafafa,#f5f5f5)] px-8 py-6 md:w-[450px] dark:border-zinc-700 dark:bg-[linear-gradient(180deg,#27272a,#20202070)]"
            key={idx}>
            <div className="flex flex-col-reverse  gap-4 items-start justify-between">
              ...
              <div className="relative z-20 mt-6 flex flex-row items-start">
                <span
                  className="text-xl leading-[1.6] font-normal text-neutral-500 dark:text-gray-400">
                  {item.title}
                </span>
              </div>
            </div>
